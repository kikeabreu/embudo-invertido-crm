        ...
        <div style={{ minHeight: "100vh", background: G.bg, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 32 }}>
            <div style={{ width: "100%", maxWidth: 480 }}>
                ...
                <div style={{ display: "flex", gap: 8, marginTop: 8 }}>
                    ...
                    <button onClick={() => { if (name.trim()) { onCreate(name.trim()); setName(""); } }} style={{ ...css.btn(), borderRadius: 10, whiteSpace: "nowrap", boxShadow: "0 8px 24px rgba(15,23,42,0.08)" }}>+ Crear</button>
                </div>
            </div>
        </div>
    );
